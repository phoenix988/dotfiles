...
-- Creates the main volume widget
theme.volume = lain.widget.alsabar({
    width = var.bar_width_vol,
    border_width = 0,
    ticks = true,
    ticks_size = 13,
...
-- Create the click actions of the volume bar
...
-- Create background and margin of the volume bar and sets the size
...
-- Create background and margin of the volume icon
