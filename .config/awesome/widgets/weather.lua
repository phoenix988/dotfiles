...
M.widget = lain.widget.weather({
    ...
    settings = function()
        ...
        widget.markup = '<span foreground="' .. theme.fg_focus .. '" background="' .. theme.bg_normal .. '" font="' .. font.update .. '">'  .. text .. '</span>'
    end
})
...
M.widget_2 = lain.widget.weather({
    ...
    settings = function()
        -- Format the weather widget text
        local text = weather_now["main"]["temp"] .. "°C "
        widget.markup = '<span foreground="' .. theme.fg_icon .. '" background="' .. theme.seperator_2 .. '" font="' .. font.update .. '">'  .. text .. '</span>'
    end
})
