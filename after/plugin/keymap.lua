...
v.api.nvim_set_keymap("n", "<F5>", ':NvimTreeToggle<CR>', { noremap = true, silent = true })
v.api.nvim_set_keymap("n", "<Leader>nt", ':NvimTreeToggle<CR>', { noremap = true, silent = true })
...
v.api.nvim_set_keymap("n", "<Leader>fr",
